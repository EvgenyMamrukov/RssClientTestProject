...
public class RssFeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView rssFeedList = findViewById(R.id.rss_feed_list);
        RssFeedViewController rssFeedViewController = new RssFeedViewController(rssFeedList, rssFeedPresenter);
